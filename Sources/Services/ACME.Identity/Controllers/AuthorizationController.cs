...
/// <summary>
///  Disable swagger due conflicting endpoints
/// </summary>
...
public class AuthorizationController : Controller
{
    ...
    public async Task<IActionResult> Authorize()
    {
        ...
        var user = await _userManager.FindByEmailAsync(result.Principal.Claims.FirstOrDefault(p => p.Type == ClaimTypes.NameIdentifier)?.Value);
        ...
        switch (await _applicationManager.GetConsentTypeAsync(application))
        {
            ...
            case ConsentTypes.Explicit when authorizations.Any() && !request.HasPrompt(Prompts.Consent):
                ...
                // this maps the claims from the identity to the claims in the token
                // accessToken is internal and id token is the jwt token
    ...
    [HttpPost("~/connect/authorize")] // temp off ValidateAntiForgeryToken
    public async Task<IActionResult> Accept()
    {
        ...
        var user = await _userManager.FindByEmailAsync(User.Claims.FirstOrDefault(p => p.Type == ClaimTypes.NameIdentifier)?.Value) ??
            throw new InvalidOperationException("The user details cannot be retrieved.");
    ...
    [HttpPost("~/connect/logout")] // temp off ValidateAntiForgeryToken
